...
module.exports = {
  default: {
    ...
    /**
     * Timeout for individual step execution (milliseconds)
     * @type {number}
     */
    timeout: 45000, // Increased from default 30000ms
    /**
     ...
     * @type {string[]}
     */
    import: ["./step-definitions/**/*.js", "./hooks/**/*.js"], // path to the step definitions and hooks
